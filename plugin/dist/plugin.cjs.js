...
class GoogleMap {
    ...
    async takeSnapshot(format, quality) {
    ...
    */
    ...
    async setOnMapLongClickListener(callback) {
    ...
    async setOnMapDoubleClickListener(callback) {
        if (core.Capacitor.isNativePlatform())
            throw new Error('Not suppoted on native.');
    ...
    async setOnMapLoadedListener(callback) {
    ...
    async setOnZoomChangedListener(callback) {
...
class CapacitorGoogleMapsWeb extends core.WebPlugin {
    ...
    async addMarkers(_args) {
        ...
        for (const markerArgs of _args.markers) {
            ...
            map.recomputeFlags[id] = (_a = markerArgs.recompute) !== null && _a !== void 0 ? _a : true;
    ...
    async addMarker(_args) {
        ...
        this.maps[_args.id].recomputeFlags[id] = (_a = _args.marker.recompute) !== null && _a !== void 0 ? _a : true;
    ...
    async updateMarker(args) {
        ...
        const newMarker = this.buildMarkerOpts(args.marker, map.map);
        ...
        map.recomputeFlags[newId] = (_a = args.marker.recompute) !== null && _a !== void 0 ? _a : true;
    ...
    recomputeSpread(mapId) {
        ...
        const R_METERS = 8;
        const map = this.maps[mapId];
        const eligibleMarkerIds = Object.keys(map.markers).filter(markerId => { var _a; return (_a = map.recomputeFlags[markerId]) !== null && _a !== void 0 ? _a : true; });
